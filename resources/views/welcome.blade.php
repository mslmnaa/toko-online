...
<div class="relative  h-screen max-h-[800px] min-h-[600px] overflow-hidden">
    <div 
        ...
        x-data
        x-init="$el.style.transform = `translateY(${window.pageYOffset * 0.5}px)`"
    ...
    <div class="relative h-full flex items-center justify-center text-center">
        <div class="max-w-4xl mx-auto px-4">
            ...
            <p class="text-xl md:text-2xl text-gray-200 mb-10 opacity-0 translate-y-10 animate-fade-in-up animation-delay-300">
...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24">
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
        @foreach([
            ...
            <div class="group bg-white p-8 rounded-xl shadow-lg border border-gray-100 
                        transform transition-all duration-500 hover:-translate-y-2 hover:shadow-2xl
                        fade-in-section">
                <div class="text-4xl text-primary-600 mb-6 transform transition-transform duration-500 group-hover:scale-110 group-hover:rotate-12">
...
<div class="relative bg-primary-50 py-24 overflow-hidden">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
        <div class="bg-white rounded-2xl shadow-xl overflow-hidden transform hover:scale-[1.02] transition-transform duration-500">
            <div class="flex flex-col md:flex-row">
                <div class="md:w-1/2">
                    <div class="relative h-full min-h-[400px]">
                        <div class="absolute inset-0 bg-[url('/img/kopi1.jpg')] bg-cover bg-center transform transition-transform duration-700 hover:scale-110"></div>
                ...
                <div class="md:w-1/2 p-8 md:p-12 flex flex-col justify-center fade-in-section">
                    ...
                    <div class="flex flex-wrap gap-4">
                        <button class="inline-flex items-center bg-primary-600 text-white px-6 py-3 rounded-full 
                        ...
                        <button class="inline-flex items-center bg-transparent text-primary-600 border-2 border-primary-600 
